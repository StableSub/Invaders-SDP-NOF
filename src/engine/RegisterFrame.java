...
public class RegisterFrame extends JFrame {
    ...
    public RegisterFrame(UserDatabase db) {
        ...
        textEmail.setBounds(150, 130, 160, 25); // 위치 및 크기 설정
        add(textEmail); // 필드 추가

        JButton registerButton = new JButton("Register"); // 회원가입 버튼 생성
        registerButton.setBounds(150, 180, 100, 25); // 위치 및 크기 설정
        ...
        registerButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (db.registerUser(id, password, email)) { // UserDatabase에 사용자 정보 저장
